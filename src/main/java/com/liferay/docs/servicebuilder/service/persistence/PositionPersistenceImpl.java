...
import com.liferay.docs.servicebuilder.model.impl.PositionImpl;
import com.liferay.docs.servicebuilder.model.impl.PositionModelImpl;
...
public class PositionPersistenceImpl extends BasePersistenceImpl<Position>
    ...
    protected Position toUnwrappedModel(Position position) {
        ...
        positionImpl.setArchived(position.getArchived());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.liferay.docs.servicebuilder.model.Position")));
