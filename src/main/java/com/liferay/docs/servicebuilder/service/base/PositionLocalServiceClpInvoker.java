...
public class PositionLocalServiceClpInvoker {
    ...
    public PositionLocalServiceClpInvoker() {
        ...
        _methodName46 = "addPosition";

        _methodParameterTypes46 = new String[] { "view.Position" };
        ...
        _methodName49 = "updatePosition";

        _methodParameterTypes49 = new String[] { "view.Position" };
    }
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return PositionLocalServiceUtil.addPosition((com.liferay.docs.servicebuilder.model.Position) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return PositionLocalServiceUtil.deletePosition((com.liferay.docs.servicebuilder.model.Position) arguments[0]);
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return PositionLocalServiceUtil.updatePosition((com.liferay.docs.servicebuilder.model.Position) arguments[0]);
        }
        ...
        if (_methodName46.equals(name) &&
            ...
            return PositionLocalServiceUtil.addPosition((view.Position) arguments[0]);
        }

        if (_methodName47.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes47, parameterTypes)) {
            return PositionLocalServiceUtil.findAll();
        }

        if (_methodName48.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes48, parameterTypes)) {
            return PositionLocalServiceUtil.findById(((Long) arguments[0]).longValue());
        }

        if (_methodName49.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes49, parameterTypes)) {
            return PositionLocalServiceUtil.updatePosition((view.Position) arguments[0]);
        }
